...
SECRET_KEY = os.environ.get('SECRET_KEY', ')untd_i@_&f=zd+ux0&!w!^3d2dk3lz#0+6vd+!1=)k*!dt2m_')
...
if 'USE_AWS' in os.environ:
    ...
    # Bucket Config
    AWS_STORAGE_BUCKET_NAME = 'supplemint-91663a1226fd'
...
EMAIL_HOST_PASSWORD = 'dekjztqfvgpzeuso'
