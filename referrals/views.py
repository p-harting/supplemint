...
def referral_dashboard(request):
    try:
        ...
        redeemable_balance = calculate_redeemable_balance(referral_code.total_earnings, redeemed_amount)
    ...
    if request.method == 'POST':
        try:
            ...
            ReferralTransaction.objects.create(
                ...
                description=f"Redeemed ${redeemable_balance} as discount code {discount_code.code}",
