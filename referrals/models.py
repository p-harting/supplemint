...
class ReferralCode(models.Model):
    ...
    unredeemed_balance = models.DecimalField(
        max_digits=10, decimal_places=2, default=0)

    def update_balances(self):
        """
        Recalculates the total earnings and unredeemed balance for the
        referral code.
        """
...
class ReferralTransaction(models.Model):
    ...
    referred_user = models.ForeignKey(
        User, on_delete=models.CASCADE, related_name='referral_purchases',
    ...
    def save(self, *args, **kwargs):
        """
        Saves the transaction and updates the associated referral code's
        balances.
        """
        ...
        referral_code.unredeemed_balance = max(
            0, referral_code.total_earnings + redeemed_amount)
        referral_code.save()
