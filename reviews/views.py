...
def add_review(request, product_id):
    ...
    If the user is submitting a new review, the review is saved and the
    ...
    if existing_review:
        ...
        form_html = render_to_string(
            'reviews/review_form.html', context, request=request)
        return JsonResponse(
            {'form_html': form_html, 'is_edit': True,
    ...
    form_html = render_to_string('reviews/review_form.html',
...
def edit_review(request, review_id):
    ...
    The user can modify their review, and the product rating is recalculated
    after the update.
    """
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            approved_reviews = Review.objects.filter(
                product=review.product, approved=True)
...
def sort_reviews(request, product_id):
    ...
    Reviews can be sorted by the newest, oldest, highest rating, or
    lowest rating.
    ...
    html = render_to_string(
        'reviews/partials/review_list.html', context, request=request)
    return JsonResponse({
        'html': html,
